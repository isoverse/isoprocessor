...
## Functionality
 ...
 - for an example of how to work with continuos flow data, see the vignette on **[Continuous Flow](https://kopflab.github.io/isoprocessor/articles/continuous_flow.html)** 
 - for an example of how to work with dual inlet data, see the vignette on **[Dual Inlet](https://kopflab.github.io/isoprocessor/articles/dual_inlet.html)**
 - additional vignettes on data reduction and calibration are in the works

## Open Source

[isoprocessor](https://kopflab.github.io/isoprocessor/) is and will always be fully open-source (i.e. free as in 'freedom' and free as in 'free beer') and is provided as is. The source code is released under GPL-2.
