...
Isoprocessor supports several plotting and data conversion functions specifically for continuous flow data. This vignette shows some of the functionality for continuous flow files read by the [isoreader package](https://isoprocessor.kopflab.org) (see the [corresponding vignette](https://isoreader.kopflab.org/articles/continuous_flow.html) for details on data retrieval, storage and export). 
